/**
 *Submitted for verification at BscScan.com on 2024-05-23
*/
...
contract BOPB {
    ...
    string public name = "BIOPOP CHAIN";
    string public symbol = "BOPB";
    ...
    function burn(uint value) external onlyAdmin() returns (bool) {
